            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    <li><a href="dashboard-job.html"><span
                                class="badge rounded-pill text-bg-success float-end" key="t-new">New</span>
                            <span key="t-jobs">Jobs</span></a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="sub-menu" aria-expanded="false">
                    ...
                    <li><a href="ui-utilities.html"><span key="t-utilities">Utilities</span> <span
                                class="badge rounded-pill bg-success float-end" key="t-new">New</span></a>
                    </li>
                </ul>
            </li>
